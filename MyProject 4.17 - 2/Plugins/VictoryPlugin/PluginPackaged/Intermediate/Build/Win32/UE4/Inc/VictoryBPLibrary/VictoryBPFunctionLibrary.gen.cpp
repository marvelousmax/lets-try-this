...
static struct FScriptStruct_VictoryBPLibrary_StaticRegisterNativesFVictoryInput
{
	...
	UFunction* Z_Construct_UFunction_UVictoryBPFunctionLibrary_Capture2D_SaveImage()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("DefaultToSelf"), TEXT("Target"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/VictoryBPFunctionLibrary.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Currently the only supported format for this function is B8G8R8A8. Make sure to include the appropriate image extension in your file path! Recommended: .bmp, .jpg, .png. Contributed by Community Member Kris!"));
	...
	UFunction* Z_Construct_UFunction_UVictoryBPFunctionLibrary_LoadStringFromFile()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LoadStringFromFile"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x04422401, 65535, sizeof(VictoryBPFunctionLibrary_eventLoadStringFromFile_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReturnValue, VictoryBPFunctionLibrary_eventLoadStringFromFile_Parms);
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReturnValue, VictoryBPFunctionLibrary_eventLoadStringFromFile_Parms), 0x0010000000000580, CPP_BOOL_PROPERTY_BITMASK(ReturnValue, VictoryBPFunctionLibrary_eventLoadStringFromFile_Parms), sizeof(bool), true);
			UProperty* NewProp_FullFilePath = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("FullFilePath"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(FullFilePath, VictoryBPFunctionLibrary_eventLoadStringFromFile_Parms), 0x0010000000000080);
			UProperty* NewProp_Result = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Result"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(Result, VictoryBPFunctionLibrary_eventLoadStringFromFile_Parms), 0x0010000000000180);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			...
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_FullFilePath"), TEXT("Enter Full File Path"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/VictoryBPFunctionLibrary.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Load a text file to a single string that you can use ParseIntoArray on newline characters if you want same format as LoadStringArrayFromFile. This version supports unicode characters!"));
#endif
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UVictoryBPFunctionLibrary()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_UVictoryBPFunctionLibrary_LoadStringFromFile());
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_Capture2D_SaveImage(), "Capture2D_SaveImage"); // 3102715652
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_CaptureComponent2D_SaveImage(), "CaptureComponent2D_SaveImage"); // 3360223069
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_LoadStringFromFile(), "LoadStringFromFile"); // 3180375325
	...
	IMPLEMENT_CLASS(UVictoryBPFunctionLibrary, 1216105597);
